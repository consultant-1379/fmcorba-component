...
public class TestFailedNotifIRP extends CorbaComponentTest {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(TestFailedNotifIRP.class);
	...
	// @Test
	public  void testFailedNotificationIRP() {
		try {
			...
			node1.failNotificationIRP();
			Thread.sleep(15000);
			LOGGER.debug("Checking for CRITICAL");
			CorbaComponentTest.checkHBAlarm("CRITICAL");
			LOGGER.debug("Restarting notification IRP");
			node1.restartNotificationIRP();
			Thread.sleep(15000);
			LOGGER.debug("Checking for CLEARED");
