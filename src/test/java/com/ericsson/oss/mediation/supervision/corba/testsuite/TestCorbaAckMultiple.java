...
public class TestCorbaAckMultiple extends CorbaComponentTest {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(TestCorbaAckMultiple.class);
	...
	public void testAckOperation() {
		try {
			...
			Assert.assertEquals("ackOperator", node1.getAckUserID());
			Assert.assertEquals(1, node1.getAlarm_information_id_list().length);
			Assert.assertEquals("874124861", node1.getAlarm_information_id_list()[0]);
			...
			Assert.assertEquals("ackOperator", node1.getAckUserID());
			Assert.assertEquals(1, node1.getAlarm_information_id_list().length);
			Assert.assertEquals("874124862", node1.getAlarm_information_id_list()[0]);
			...
			Assert.assertEquals("ackOperator", node1.getAckUserID());
			Assert.assertEquals(1, node1.getAlarm_information_id_list().length);
			Assert.assertEquals("874124863", node1.getAlarm_information_id_list()[0]);
