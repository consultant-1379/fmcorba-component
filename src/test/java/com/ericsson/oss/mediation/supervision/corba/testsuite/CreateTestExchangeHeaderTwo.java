...
public class CreateTestExchangeHeaderTwo {
	public static Map<String,Object> createHeaders() {
		...
		headers.put(DPSConstants.SUBORDINATE_OBJECT_SYNCSUPPORTED,
				true);
		headers.put(DPSConstants.NODE_INFO_TYPE,
				true);
		...
		headers.put(CorbaManagedElement.ALARM_IRP_AGENT_VERSION,"ALARM_IRP_VERSION_1_1");
		headers.put(CorbaManagedElement.NOTIFICATION_IRP_AGENT_VERSION,"NOTIFICATION_IRP_VERSION_1_1");
		return headers;
	}
}
