...
org.omg.CORBA.portable.InvokeHandler, com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplierOperations {

  public com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplier _this () {
   return com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplierHelper.narrow(super._this_object());
  }

  public com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplier _this (org.omg.CORBA.ORB orb) {
    return com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplierHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_push_consumer", new int[] { 0, 0 });
  _methods.put("disconnect_push_supplier", new int[] { 1, 0 });
  }
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplierPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (com.ericsson.irp.CosEventChannelAdmin.ProxyPushSupplierOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
