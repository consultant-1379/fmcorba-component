...
public final class NotificationCategorySetHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final java.lang.String[] _vis_value) {
    any.type(com.ericsson.irp.NotificationIRPConstDefs.NotificationCategorySetHelper.type());
    any.insert_Streamable(new com.ericsson.irp.NotificationIRPConstDefs.NotificationCategorySetHolder(_vis_value));
  }

  public static java.lang.String[] extract (final org.omg.CORBA.Any any) {
    java.lang.String[] _vis_value;
    _vis_value = com.ericsson.irp.NotificationIRPConstDefs.NotificationCategorySetHelper.read(any.create_input_stream());
    return _vis_value;
  }
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "NotificationCategorySet", originalType);
        }
      }
    }
    return _type;
