...
org.omg.CORBA.portable.InvokeHandler, com.ericsson.irp.CosEventComm.PullConsumerOperations {

  public com.ericsson.irp.CosEventComm.PullConsumer _this () {
   return com.ericsson.irp.CosEventComm.PullConsumerHelper.narrow(super._this_object());
  }

  public com.ericsson.irp.CosEventComm.PullConsumer _this (org.omg.CORBA.ORB orb) {
    return com.ericsson.irp.CosEventComm.PullConsumerHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("disconnect_pull_consumer", new int[] { 0, 0 });
  }
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (com.ericsson.irp.CosEventComm.PullConsumerOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
