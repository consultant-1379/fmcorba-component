 ...
 * <li> <b>IDL Name</b>      ::CosNotifyFilter::CallbackID
 * <li> <b>Repository Id</b> IDL:omg.org/CosNotifyFilter/CallbackID:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
...
public final class CallbackIDHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final int _vis_value) {
    any.type(com.ericsson.irp.CosNotifyFilter.CallbackIDHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "CallbackID", originalType);
        }
      }
    }
    return _type;
