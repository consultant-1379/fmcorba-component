 ...
 * </pre>
 */
public abstract class NotifyPublishPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, com.ericsson.irp.CosNotifyComm.NotifyPublishOperations {

  public com.ericsson.irp.CosNotifyComm.NotifyPublish _this () {
   return com.ericsson.irp.CosNotifyComm.NotifyPublishHelper.narrow(super._this_object());
  }

  public com.ericsson.irp.CosNotifyComm.NotifyPublish _this (org.omg.CORBA.ORB orb) {
    return com.ericsson.irp.CosNotifyComm.NotifyPublishHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("offer_change", new int[] { 0, 0 });
  }
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (com.ericsson.irp.CosNotifyComm.NotifyPublishOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
