...
org.omg.CORBA.portable.InvokeHandler, com.ericsson.irp.CosNotifyComm.PushSupplierOperations {

  public com.ericsson.irp.CosNotifyComm.PushSupplier _this () {
   return com.ericsson.irp.CosNotifyComm.PushSupplierHelper.narrow(super._this_object());
  }

  public com.ericsson.irp.CosNotifyComm.PushSupplier _this (org.omg.CORBA.ORB orb) {
    return com.ericsson.irp.CosNotifyComm.PushSupplierHelper.narrow(super._this_object(orb));
  }
  ...
  _methods.put("disconnect_push_supplier", new int[] { 2, 0 });
  }
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (com.ericsson.irp.CosNotifyComm.PushSupplierOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
