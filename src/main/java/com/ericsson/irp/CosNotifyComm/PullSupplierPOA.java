...
org.omg.CORBA.portable.InvokeHandler, com.ericsson.irp.CosNotifyComm.PullSupplierOperations {

  public com.ericsson.irp.CosNotifyComm.PullSupplier _this () {
   return com.ericsson.irp.CosNotifyComm.PullSupplierHelper.narrow(super._this_object());
  }

  public com.ericsson.irp.CosNotifyComm.PullSupplier _this (org.omg.CORBA.ORB orb) {
    return com.ericsson.irp.CosNotifyComm.PullSupplierHelper.narrow(super._this_object(orb));
  }
  ...
  _methods.put("pull", new int[] { 2, 0 });
  _methods.put("try_pull", new int[] { 2, 1 });
  _methods.put("disconnect_pull_supplier", new int[] { 2, 2 });
  }
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (com.ericsson.irp.CosNotifyComm.PullSupplierOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
