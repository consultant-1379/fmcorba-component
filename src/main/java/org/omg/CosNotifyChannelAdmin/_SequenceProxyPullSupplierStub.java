 ...
 * </pre>
 */
public class _SequenceProxyPullSupplierStub extends org.omg.CosNotifyChannelAdmin._ProxySupplierStub implements org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier {
  /**
	 * 
	 */
	private static final long serialVersionUID = 1878554052547609768L;
final public static Class<SequenceProxyPullSupplierOperations> _opsClass = org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations.class;
  ...
  public void connect_sequence_pull_consumer (com.ericsson.irp.CosNotifyComm.SequencePullConsumer pull_consumer) throws  com.ericsson.irp.CosEventChannelAdmin.AlreadyConnected {
    ...
    while (true) {
      if (!_is_local()) {
        ...
        try {
          _output = this._request("connect_sequence_pull_consumer", true);
          com.ericsson.irp.CosNotifyComm.SequencePullConsumerHelper.write(_output, pull_consumer);
        ...
        final org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("connect_sequence_pull_consumer", _opsClass);
        if (_so == null) {
          continue;
        }
        final org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations _self = (org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations)_so.servant;
        try {
  ...
  public com.ericsson.irp.CosNotifyComm.SequencePullSupplier __com_ericsson_irp_CosNotifyComm_SequencePullSupplier;
  ...
  public void _set_delegate (org.omg.CORBA.portable.Delegate _vis_obj_delegate) {
    ...
    this.__com_ericsson_irp_CosNotifyComm_SequencePullSupplier = new com.ericsson.irp.CosNotifyComm._SequencePullSupplierStub();
    ((org.omg.CORBA.portable.ObjectImpl) this.__com_ericsson_irp_CosNotifyComm_SequencePullSupplier)._set_delegate(_vis_obj_delegate);
  ...
  public org.omg.CosNotification.StructuredEvent[] pull_structured_events (int max_number) throws  com.ericsson.irp.CosEventComm.Disconnected {
    return this.__com_ericsson_irp_CosNotifyComm_SequencePullSupplier.pull_structured_events(max_number);
  }
  ...
  public org.omg.CosNotification.StructuredEvent[] try_pull_structured_events (int max_number, 
    ...
    return this.__com_ericsson_irp_CosNotifyComm_SequencePullSupplier.try_pull_structured_events(max_number, 
                                                                                                 has_event);
  }
  ...
  public void disconnect_sequence_pull_supplier () {
    this.__com_ericsson_irp_CosNotifyComm_SequencePullSupplier.disconnect_sequence_pull_supplier();
  }
