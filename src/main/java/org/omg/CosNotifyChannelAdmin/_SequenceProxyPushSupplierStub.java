 ...
 * </pre>
 */
public class _SequenceProxyPushSupplierStub extends org.omg.CosNotifyChannelAdmin._ProxySupplierStub implements org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier {
  /**
	 * 
	 */
	private static final long serialVersionUID = 3112339578793730834L;
final public static Class<SequenceProxyPushSupplierOperations> _opsClass = org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations.class;
  ...
  public void resume_connection () throws  org.omg.CosNotifyChannelAdmin.ConnectionAlreadyActive, 
    ...
    while (true) {
      if (!_is_local()) {
        ...
        final org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations _self = (org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations)_so.servant;
        try {
  ...
  public void connect_sequence_push_consumer (com.ericsson.irp.CosNotifyComm.SequencePushConsumer push_consumer) throws  com.ericsson.irp.CosEventChannelAdmin.AlreadyConnected, 
    ...
    while (true) {
      if (!_is_local()) {
        ...
        org.omg.CORBA.portable.InputStream  _input  = null;
        try {
          _output = this._request("connect_sequence_push_consumer", true);
          com.ericsson.irp.CosNotifyComm.SequencePushConsumerHelper.write(_output, push_consumer);
          _input = this._invoke(_output);
        }
        catch (org.omg.CORBA.portable.ApplicationException _exception) {
          java.lang.String _exception_id = _exception.getId();
        ...
        final org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("connect_sequence_push_consumer", _opsClass);
        if (_so == null) {
          continue;
        }
        final org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations _self = (org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations)_so.servant;
        try {
          _self.connect_sequence_push_consumer(push_consumer);
          if (_so instanceof org.omg.CORBA.portable.ServantObjectExt) {
            ((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
          }
  ...
  public com.ericsson.irp.CosNotifyComm.SequencePushSupplier __com_ericsson_irp_CosNotifyComm_SequencePushSupplier;
  ...
  public void _set_delegate (org.omg.CORBA.portable.Delegate _vis_obj_delegate) {
    ...
    this.__com_ericsson_irp_CosNotifyComm_SequencePushSupplier = new com.ericsson.irp.CosNotifyComm._SequencePushSupplierStub();
    ((org.omg.CORBA.portable.ObjectImpl) this.__com_ericsson_irp_CosNotifyComm_SequencePushSupplier)._set_delegate(_vis_obj_delegate);
  ...
  public void disconnect_sequence_push_supplier () {
    this.__com_ericsson_irp_CosNotifyComm_SequencePushSupplier.disconnect_sequence_push_supplier();
  }
