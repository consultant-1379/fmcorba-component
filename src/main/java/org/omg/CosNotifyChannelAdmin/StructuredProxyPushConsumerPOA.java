 ...
 * </pre>
 */
public abstract class StructuredProxyPushConsumerPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations {

  public org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumer _this () {
   return org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerHelper.narrow(super._this_object());
  }

  public org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumer _this (org.omg.CORBA.ORB orb) {
    return org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_structured_push_supplier", new int[] { 0, 0 });
  ...
  _methods.put("push_structured_event", new int[] { 4, 0 });
  _methods.put("disconnect_structured_push_consumer", new int[] { 4, 1 });
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
  ...
  org.omg.CORBA.portable.OutputStream _output = null;
  {
    ...
    case 0: {
    try {
      com.ericsson.irp.CosNotifyComm.StructuredPushSupplier push_supplier;
      push_supplier = com.ericsson.irp.CosNotifyComm.StructuredPushSupplierHelper.read(_input);
