...
public org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumer value;

public StructuredProxyPullConsumerHolder () {
}

public StructuredProxyPullConsumerHolder (final org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumer _vis_value) {
  this.value = _vis_value;
}

public void _read (final org.omg.CORBA.portable.InputStream input) {
  value = org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumerHelper.read(input);
}

public void _write (final org.omg.CORBA.portable.OutputStream output) {
  org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumerHelper.write(output, value);
}

public org.omg.CORBA.TypeCode _type () {
  return org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumerHelper.type();
}
}
