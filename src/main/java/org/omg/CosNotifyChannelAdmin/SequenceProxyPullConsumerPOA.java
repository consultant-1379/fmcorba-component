 ...
 * </pre>
 */
public abstract class SequenceProxyPullConsumerPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations {

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumer _this () {
   return org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerHelper.narrow(super._this_object());
  }

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumer _this (org.omg.CORBA.ORB orb) {
    return org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_sequence_pull_supplier", new int[] { 0, 0 });
  ...
  _methods.put("disconnect_sequence_pull_consumer", new int[] { 4, 0 });
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
  ...
  org.omg.CORBA.portable.OutputStream _output = null;
  {
    ...
    case 0: {
    try {
      com.ericsson.irp.CosNotifyComm.SequencePullSupplier pull_supplier;
      pull_supplier = com.ericsson.irp.CosNotifyComm.SequencePullSupplierHelper.read(_input);
