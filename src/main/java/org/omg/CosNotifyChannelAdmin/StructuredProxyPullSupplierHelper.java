...
public final class StructuredProxyPullSupplierHelper {
  ...
  public static org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotifyChannelAdmin._StructuredProxyPullSupplierStub result = new org.omg.CosNotifyChannelAdmin._StructuredProxyPullSupplierStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier)obj);
  }
  ...
  public static org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotifyChannelAdmin._StructuredProxyPullSupplierStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplierHelper.type());
  }

  public static org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplierHelper.narrow(_obj);
    return _vis_value;
  }
  ...
  public static org.omg.CORBA.TypeCode type () {
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          _type = _orb().create_interface_tc(id(), "StructuredProxyPullSupplier");
        }
      }
    }
    return _type;
