...
public final class SequenceProxyPushSupplierHelper {
  ...
  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotifyChannelAdmin._SequenceProxyPushSupplierStub result = new org.omg.CosNotifyChannelAdmin._SequenceProxyPushSupplierStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier)obj);
  }
  ...
  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotifyChannelAdmin._SequenceProxyPushSupplierStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.type());
  }

  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(_obj);
    return _vis_value;
  }
  ...
  public static org.omg.CORBA.TypeCode type () {
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          _type = _orb().create_interface_tc(id(), "SequenceProxyPushSupplier");
        }
      }
    }
    return _type;
