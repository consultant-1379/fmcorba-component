 ...
 * </pre>
 */
public class _ProxySupplierStub extends org.omg.CosNotification._QoSAdminStub implements org.omg.CosNotifyChannelAdmin.ProxySupplier {
  /**
	 * 
	 */
	private static final long serialVersionUID = -741129503824653234L;
final public static Class<ProxySupplierOperations> _opsClass = org.omg.CosNotifyChannelAdmin.ProxySupplierOperations.class;
  ...
  public void validate_event_qos (org.omg.CosNotification.Property[] required_qos, 
    ...
    while (true) {
      if (!_is_local()) {
        ...
        final org.omg.CosNotifyChannelAdmin.ProxySupplierOperations _self = (org.omg.CosNotifyChannelAdmin.ProxySupplierOperations)_so.servant;
        try {
  ...
  public org.omg.CosNotification.EventType[] obtain_offered_types (org.omg.CosNotifyChannelAdmin.ObtainInfoMode mode) {
    ...
    while (true) {
      if (!_is_local()) {
        ...
        try {
          _output = this._request("obtain_offered_types", true);
        ...
        final org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("obtain_offered_types", _opsClass);
        if (_so == null) {
          continue;
        }
        final org.omg.CosNotifyChannelAdmin.ProxySupplierOperations _self = (org.omg.CosNotifyChannelAdmin.ProxySupplierOperations)_so.servant;
        try {
          org.omg.CosNotification.EventType[] _ret = _self.obtain_offered_types(mode);
          if (_so instanceof org.omg.CORBA.portable.ServantObjectExt) {
            ((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
          }
          return _ret;
  ...
  public org.omg.CosNotifyChannelAdmin.ConsumerAdmin MyAdmin () {
    ...
    while (true) {
      if (!_is_local()) {
        ...
        final org.omg.CosNotifyChannelAdmin.ProxySupplierOperations _self = (org.omg.CosNotifyChannelAdmin.ProxySupplierOperations)_so.servant;
        try {
          org.omg.CosNotifyChannelAdmin.ConsumerAdmin _ret = _self.MyAdmin();
          if (_so instanceof org.omg.CORBA.portable.ServantObjectExt) {
            ((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
          }
          return _ret;
