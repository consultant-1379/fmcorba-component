 ...
 * </pre>
 */
public abstract class SequenceProxyPushSupplierPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations {

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this () {
   return org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(super._this_object());
  }

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this (org.omg.CORBA.ORB orb) {
    return org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_sequence_push_consumer", new int[] { 0, 0 });
  ...
  _methods.put("disconnect_sequence_push_supplier", new int[] { 4, 0 });
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
      ...
      case 4: {
        return com.ericsson.irp.CosNotifyComm.SequencePushSupplierPOA._invoke(this, method[1], _input, handler);
      }
      case 5: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
  ...
  org.omg.CORBA.portable.OutputStream _output = null;
  {
    ...
    case 0: {
    try {
      com.ericsson.irp.CosNotifyComm.SequencePushConsumer push_consumer;
      push_consumer = com.ericsson.irp.CosNotifyComm.SequencePushConsumerHelper.read(_input);
