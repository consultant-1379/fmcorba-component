...
public final class ConsumerAdminHelper {
  ...
  private static org.omg.CosNotifyChannelAdmin.ConsumerAdmin narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotifyChannelAdmin._ConsumerAdminStub result = new org.omg.CosNotifyChannelAdmin._ConsumerAdminStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotifyChannelAdmin.ConsumerAdmin)obj);
  }
  ...
  public static org.omg.CosNotifyChannelAdmin.ConsumerAdmin read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotifyChannelAdmin._ConsumerAdminStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotifyChannelAdmin.ConsumerAdmin _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotifyChannelAdmin.ConsumerAdmin _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotifyChannelAdmin.ConsumerAdminHelper.type());
  }

  public static org.omg.CosNotifyChannelAdmin.ConsumerAdmin extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotifyChannelAdmin.ConsumerAdmin _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotifyChannelAdmin.ConsumerAdminHelper.narrow(_obj);
    return _vis_value;
  }
