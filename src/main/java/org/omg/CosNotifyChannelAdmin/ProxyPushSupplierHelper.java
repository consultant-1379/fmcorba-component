...
public final class ProxyPushSupplierHelper {
  ...
  public static org.omg.CosNotifyChannelAdmin.ProxyPushSupplier unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static org.omg.CosNotifyChannelAdmin.ProxyPushSupplier narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotifyChannelAdmin._ProxyPushSupplierStub result = new org.omg.CosNotifyChannelAdmin._ProxyPushSupplierStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotifyChannelAdmin.ProxyPushSupplier)obj);
  }
  ...
  public static org.omg.CosNotifyChannelAdmin.ProxyPushSupplier read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotifyChannelAdmin._ProxyPushSupplierStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotifyChannelAdmin.ProxyPushSupplier _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotifyChannelAdmin.ProxyPushSupplier _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotifyChannelAdmin.ProxyPushSupplierHelper.type());
  }

  public static org.omg.CosNotifyChannelAdmin.ProxyPushSupplier extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotifyChannelAdmin.ProxyPushSupplier _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotifyChannelAdmin.ProxyPushSupplierHelper.narrow(_obj);
    return _vis_value;
  }
