 ...
 * </pre>
 */
public class _SequenceProxyPullConsumerStub extends org.omg.CosNotifyChannelAdmin._ProxyConsumerStub implements org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumer {
  /**
	 * 
	 */
	private static final long serialVersionUID = -7352086122292392789L;
final public static Class<SequenceProxyPullConsumerOperations> _opsClass = org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations.class;
  ...
  public void resume_connection () throws  org.omg.CosNotifyChannelAdmin.ConnectionAlreadyActive, 
    ...
    while (true) {
      if (!_is_local()) {
        ...
        final org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations _self = (org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations)_so.servant;
        try {
  ...
  public void connect_sequence_pull_supplier (com.ericsson.irp.CosNotifyComm.SequencePullSupplier pull_supplier) throws  com.ericsson.irp.CosEventChannelAdmin.AlreadyConnected, 
    ...
    while (true) {
      if (!_is_local()) {
        ...
        org.omg.CORBA.portable.InputStream  _input  = null;
        try {
          _output = this._request("connect_sequence_pull_supplier", true);
          com.ericsson.irp.CosNotifyComm.SequencePullSupplierHelper.write(_output, pull_supplier);
          _input = this._invoke(_output);
        }
        catch (org.omg.CORBA.portable.ApplicationException _exception) {
          java.lang.String _exception_id = _exception.getId();
        ...
        final org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("connect_sequence_pull_supplier", _opsClass);
        if (_so == null) {
          continue;
        }
        final org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations _self = (org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations)_so.servant;
        try {
          _self.connect_sequence_pull_supplier(pull_supplier);
          if (_so instanceof org.omg.CORBA.portable.ServantObjectExt) {
            ((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
          }
  ...
  public com.ericsson.irp.CosNotifyComm.SequencePullConsumer __com_ericsson_irp_CosNotifyComm_SequencePullConsumer;
  ...
  public void _set_delegate (org.omg.CORBA.portable.Delegate _vis_obj_delegate) {
    ...
    this.__com_ericsson_irp_CosNotifyComm_SequencePullConsumer = new com.ericsson.irp.CosNotifyComm._SequencePullConsumerStub();
    ((org.omg.CORBA.portable.ObjectImpl) this.__com_ericsson_irp_CosNotifyComm_SequencePullConsumer)._set_delegate(_vis_obj_delegate);
  ...
  public void disconnect_sequence_pull_consumer () {
    this.__com_ericsson_irp_CosNotifyComm_SequencePullConsumer.disconnect_sequence_pull_consumer();
  }
