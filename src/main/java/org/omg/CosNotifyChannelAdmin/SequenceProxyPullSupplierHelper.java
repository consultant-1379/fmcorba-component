...
public final class SequenceProxyPullSupplierHelper {
  ...
  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotifyChannelAdmin._SequenceProxyPullSupplierStub result = new org.omg.CosNotifyChannelAdmin._SequenceProxyPullSupplierStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier)obj);
  }
  ...
  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotifyChannelAdmin._SequenceProxyPullSupplierStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplierHelper.type());
  }

  public static org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplierHelper.narrow(_obj);
    return _vis_value;
  }
  ...
  public static org.omg.CORBA.TypeCode type () {
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          _type = _orb().create_interface_tc(id(), "SequenceProxyPullSupplier");
        }
      }
    }
    return _type;
