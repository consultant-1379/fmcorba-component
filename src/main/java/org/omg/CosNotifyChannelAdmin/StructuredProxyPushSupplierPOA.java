 ...
 * </pre>
 */
public abstract class StructuredProxyPushSupplierPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations {

  public org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplier _this () {
   return org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierHelper.narrow(super._this_object());
  }

  public org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplier _this (org.omg.CORBA.ORB orb) {
    return org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_structured_push_consumer", new int[] { 0, 0 });
  ...
  _methods.put("disconnect_structured_push_supplier", new int[] { 4, 0 });
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
      ...
      case 4: {
        return com.ericsson.irp.CosNotifyComm.StructuredPushSupplierPOA._invoke(this, method[1], _input, handler);
      }
      case 5: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
  ...
  org.omg.CORBA.portable.OutputStream _output = null;
  {
    ...
    case 0: {
    try {
      com.ericsson.irp.CosNotifyComm.StructuredPushConsumer push_consumer;
      push_consumer = com.ericsson.irp.CosNotifyComm.StructuredPushConsumerHelper.read(_input);
