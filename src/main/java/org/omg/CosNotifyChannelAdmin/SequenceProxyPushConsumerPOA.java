 ...
 * </pre>
 */
public abstract class SequenceProxyPushConsumerPOA extends org.omg.PortableServer.Servant implements 
org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations {

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this () {
   return org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(super._this_object());
  }

  public org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this (org.omg.CORBA.ORB orb) {
    return org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(super._this_object(orb));
  }
  ...
  static {
  _methods.put("connect_sequence_push_supplier", new int[] { 0, 0 });
  ...
  _methods.put("push_structured_events", new int[] { 4, 0 });
  _methods.put("disconnect_sequence_push_consumer", new int[] { 4, 1 });
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method[0]) {
      case 0: {
        return org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerPOA._invoke(this, method[1], _input, handler);
      }
      case 1: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
  ...
  org.omg.CORBA.portable.OutputStream _output = null;
  {
    ...
    case 0: {
    try {
      com.ericsson.irp.CosNotifyComm.SequencePushSupplier push_supplier;
      push_supplier = com.ericsson.irp.CosNotifyComm.SequencePushSupplierHelper.read(_input);
