 ...
 * <li> <b>IDL Name</b>      ::CosNotifyChannelAdmin::AdminID
 * <li> <b>Repository Id</b> IDL:omg.org/CosNotifyChannelAdmin/AdminID:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
...
public final class AdminIDHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final int _vis_value) {
    any.type(org.omg.CosNotifyChannelAdmin.AdminIDHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "AdminID", originalType);
        }
      }
    }
    return _type;
