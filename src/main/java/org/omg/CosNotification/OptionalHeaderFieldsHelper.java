 ...
 * <li> <b>IDL Name</b>      ::CosNotification::OptionalHeaderFields
 * <li> <b>Repository Id</b> IDL:omg.org/CosNotification/OptionalHeaderFields:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
 * typedef org.omg.CosNotification.PropertySeq OptionalHeaderFields;
 * </pre>
 */
public final class OptionalHeaderFieldsHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotification.Property[] _vis_value) {
    any.type(org.omg.CosNotification.OptionalHeaderFieldsHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "OptionalHeaderFields", originalType);
        }
      }
    }
    return _type;
