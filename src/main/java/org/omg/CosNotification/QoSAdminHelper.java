...
public final class QoSAdminHelper {
  ...
  public static org.omg.CosNotification.QoSAdmin unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static org.omg.CosNotification.QoSAdmin narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    ...
    if (is_a || obj._is_a(id())) {
      ...
      org.omg.CosNotification._QoSAdminStub result = new org.omg.CosNotification._QoSAdminStub();
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (org.omg.CosNotification.QoSAdmin)obj);
  }
  ...
  public static org.omg.CosNotification.QoSAdmin read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(org.omg.CosNotification._QoSAdminStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final org.omg.CosNotification.QoSAdmin _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotification.QoSAdmin _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, org.omg.CosNotification.QoSAdminHelper.type());
  }

  public static org.omg.CosNotification.QoSAdmin extract (final org.omg.CORBA.Any any) {
    org.omg.CosNotification.QoSAdmin _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = org.omg.CosNotification.QoSAdminHelper.narrow(_obj);
    return _vis_value;
  }
