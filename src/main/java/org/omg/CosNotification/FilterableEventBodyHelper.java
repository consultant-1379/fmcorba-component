 ...
 * <li> <b>IDL Name</b>      ::CosNotification::FilterableEventBody
 * <li> <b>Repository Id</b> IDL:omg.org/CosNotification/FilterableEventBody:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
 * typedef org.omg.CosNotification.PropertySeq FilterableEventBody;
 * </pre>
 */
public final class FilterableEventBodyHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotification.Property[] _vis_value) {
    any.type(org.omg.CosNotification.FilterableEventBodyHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "FilterableEventBody", originalType);
        }
      }
    }
    return _type;
