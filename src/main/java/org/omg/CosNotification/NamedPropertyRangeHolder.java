...
public NamedPropertyRangeHolder (final org.omg.CosNotification.NamedPropertyRange _vis_value) {
  this.value = _vis_value;
}

public void _read (final org.omg.CORBA.portable.InputStream input) {
  value = org.omg.CosNotification.NamedPropertyRangeHelper.read(input);
}

public void _write (final org.omg.CORBA.portable.OutputStream output) {
  org.omg.CosNotification.NamedPropertyRangeHelper.write(output, value);
}
