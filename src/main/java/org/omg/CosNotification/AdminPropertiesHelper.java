 ...
 * <li> <b>IDL Name</b>      ::CosNotification::AdminProperties
 * <li> <b>Repository Id</b> IDL:omg.org/CosNotification/AdminProperties:1.0
 * </ul>
 * <b>IDL definition:</b>
 * <pre>
 * typedef org.omg.CosNotification.PropertySeq AdminProperties;
 * </pre>
 */
public final class AdminPropertiesHelper {
  ...
  public static void insert (final org.omg.CORBA.Any any, final org.omg.CosNotification.Property[] _vis_value) {
    any.type(org.omg.CosNotification.AdminPropertiesHelper.type());
    ...
    if (_type == null) {
      synchronized (org.omg.CORBA.TypeCode.class) {
        if (_type == null) {
          ...
          _type = _orb().create_alias_tc(id(), "AdminProperties", originalType);
        }
      }
    }
    return _type;
